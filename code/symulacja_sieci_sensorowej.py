...
class SensorNetwork:
    def __init__(self, area_size, number_of_main_units, num_sensors):
        self.sensors = []
...
coverage_radius_main_unit_transfer = np.random.uniform(20, 40, 1)

print(coverage_radius_main_unit_transfer)
